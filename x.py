...
API_TOKEN = '8134676430:AAEW_S1MYY8H2FZfErFhePuuC17za1hDOSs'
ADMIN_ID = '1786950751'
MAX_RESTARTS = 5
...
def start_bot():
    ...
    return subprocess.Popen(['python', 'x.py'])
...
async def main():
    ...
    while True:
        ...
        process = start_bot()
        await notify_admin("🤓 Wait bro Bot is starting...")

        while process.poll() is None:
            await asyncio.sleep(5)
        
        logging.warning("Bot process terminated. Restarting in 10 seconds...")
        await notify_admin("⚠️ The bot is Overloaded please wait 10 seconds.")
        restart_count += 1
